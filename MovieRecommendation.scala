...
val movies = sc.textFile("file:///home/cloudera/Desktop/Mlib/movies/u.item").map(line => { val fields = line.split("\\|")
	// format: (movieId, movieName)
        (fields(0).toInt, fields(1))
    }).collect.toMap

val ratings = sc.textFile("file:///home/cloudera/Desktop/Mlib/movies/u.data").map { line =>
